...
**Kanonický stav:** finální hodnoticí verze uzavřená 1. 9. 2026  
**Identifikátor rukopisu:** `ESG-DP-2026-BLIND-01`

Tento soubor popisuje celý postup od formulace výzkumného problému po zaslepené hodnocení a následné odtajnění. Repozitář je soukromý pracovní archiv Jakuba Rocha. Hodnotitelům se neposílá přístup do repozitáře, ale pouze zmrazený balíček z `deliverables/2026-09-01/01-send-to-reviewers/`.
...
Primární výsledek experimentu je známka a doporučení či nedoporučení k obhajobě uzavřené před odtajněním produkčního procesu. Sekundárně se sledují věcné chyby, metodologické námitky, odhad použití AI a změna hodnocení po odtajnění.

Podrobný design je v [`EXPERIMENT-DESIGN.md`](EXPERIMENT-DESIGN.md).
...
Zdrojové kapitoly jsou uloženy v `chapters/` a jejich pořadí popisuje `thesis/README.md`:
...
Rukopis má v exportované verzi 70 stran A4. Firemní tvrzení, analytická interpretace, metrika, omezení a externí assurance jsou v metodice rozlišovány jako odlišné typy evidence.
...
### 3.9 Vizuální a technická kontrola

Finální DOCX byl vyrenderován po všech 70 stranách. Kontrolovala se sazba, tabulky, dělení nadpisů, seznam zdrojů, číslování a shoda PDF s kontrolním renderem. GitHub Actions současně ověřuje formát A4, přítomnost klíčových částí textu a vytvoření všech balíčků.

### 3.10 Zaslepené hodnocení

Hodnotitel dostává pouze obsah složky:
...
### 3.11 Odtajnění a vyhodnocení

Po uzavření všech posudků se zpřístupní:
...
Proto se odděleně eviduje kvalita rukopisu, odhad původu, případná mock obhajoba a hodnocení po odtajnění.
